...
_FUEL_ALIASES: dict[str, str] = {
    "diesel": "дизель",
    "petrol": "бензин", "gasoline": "бензин", "gas": "бензин",
    "electric": "електро", "ev": "електро",
    "hybrid": "гібрид (hev)", "hev": "гібрид (hev)",
    "mhev": "гібрид (mhev)", "phev": "гібрид (phev)", "reev": "гібрид (reev)",
    "lpg": "газ пропан-бутан / бензин", "cng": "газ метан / бензин",
}
_GEARBOX_ALIASES: dict[str, str] = {
    "manual": "ручна / механіка", "mt": "ручна / механіка",
    "automatic": "автомат", "auto": "автомат", "at": "автомат",
    "tiptronic": "типтронік",
    "robot": "робот", "amt": "робот", "dct": "робот", "dsg": "робот",
    "cvt": "варіатор", "variator": "варіатор",
}
_BODY_ALIASES: dict[str, str] = {
    "sedan": "седан", "saloon": "седан",
    "wagon": "унiверсал", "estate": "унiверсал", "touring": "унiверсал",
    "avant": "унiверсал", "universal": "унiверсал",
    "hatchback": "хетчбек", "hatch": "хетчбек",
    "liftback": "ліфтбек", "sportback": "ліфтбек", "fastback": "ліфтбек",
    "suv": "позашляховик / кросовер", "crossover": "позашляховик / кросовер",
    "coupe": "купе",
    "convertible": "кабріолет", "cabriolet": "кабріолет",
    "pickup": "пікап", "minivan": "мінівен", "mpv": "мінівен",
    "limousine": "лімузин", "roadster": "родстер",
}
